        ...
        <ul className='flex flex-row justify-end w-1/2 px-5'>
          <li className='pl-5'>
            <Link 
              ...
              className={currentPage === 'Home' ? 'nav-link active' : 'nav-link'} class="font-hand text-lg"
            >
              Home
            </Link>
          </li>
          <li className='pl-5'>
            ...
            className={currentPage === 'About' ? 'nav-link active' : 'nav-link'} class="font-hand text-lg"
            >
              About
            </Link>
          </li>
          <li className='pl-5'>
            <Link
              ...
              className={currentPage === 'Dashboard' ? 'nav-link active' : 'nav-link'} class="font-hand text-lg"
            >     
              Profile
            </Link>
          </li>
